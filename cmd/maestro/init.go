...
func buildInitYAML(cfg initYAMLConfig) string {
	...
	sb.WriteString("#   desired_outcome: Users can run the product end-to-end.\n")
	sb.WriteString("#   runtime_target: https://app.example.com\n")
	sb.WriteString("#   healthcheck_url: https://app.example.com/healthz\n")
	sb.WriteString("#   non_goals:\n")
	sb.WriteString("#     - Rewrite unrelated subsystems\n")
