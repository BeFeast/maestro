...
func TestSystemdUnit(t *testing.T) {
	pathEnv := "/usr/local/bin:/usr/bin:/bin:/home/user/.local/bin"
	content := systemdUnit("/usr/bin/maestro", "/etc/maestro.yaml", pathEnv)
	...
	if !strings.Contains(content, "Environment=PATH="+pathEnv) {
...
func TestLaunchdPlist(t *testing.T) {
	pathEnv := "/usr/local/bin:/usr/bin:/bin:/home/user/.local/bin"
	content := launchdPlist("/usr/bin/maestro", "/etc/maestro.yaml", pathEnv)
	...
	if !strings.Contains(content, "<string>"+pathEnv+"</string>") {
