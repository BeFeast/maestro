...
func (f *fakeReconcileReader) ListOpenIssues(labels []string) ([]github.Issue, error) {
	return f.issues, f.issuesErr
}
func (f *fakeReconcileReader) ListOpenPRs() ([]github.PR, error) { return f.prs, f.prsErr }
